...
/projects/academic/mshalfon/supl_scripts/tandem_repeat_mask/trf409.linux64  mapping1.test/crms.fa 2 7 7 80 10 50 500 -m -h

#/projects/academic/mshalfon/supl_scripts/tandem_repeat_mask/trf409.linux64 neg.fasta 2 7 7 80 10 50 500 -m -h


#mv mapping1.test/crms.fa crms.fasta.unmasked
#mv crms.fasta.2.7.7.80.10.50.500.mask mapping1.test/crms.fasta
